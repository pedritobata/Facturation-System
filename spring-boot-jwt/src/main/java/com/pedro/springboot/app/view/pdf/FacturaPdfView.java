package com.pedro.springboot.app.view.pdf;
...
@Component("factura/ver")//Esta clase tiene la misma ruta url que el controlador para ver facturas
//Spring resolverá a la vista html o a la pdf automáticamente verificando si le hemos enviado el parámetro format=pdf o algo así.
public class FacturaPdfView extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		PdfPTable tabla = new PdfPTable(1);//el argumento indica el nro de columnas
		...
		//Otra forma de traducir lenguajes usando un método heredado de la clase abstracta AbstractPdfView.getMessageSourceAccessor()
		//esta clase por dentro ya trabaja con MessageSource y LocaleResolver
		...
		tabla3.setWidths(new float[] {3.5f,1,1,1});//usamos medidas proporcionales
