...
@Secured(value="ROLE_ADMIN")//Acá anoto la restriccion de seguridad a nivel de clase porque 
//todos los metodos de esta clase serán afectados
@Controller
...
public class FacturaController {
	...
	@GetMapping("/ver/{id}")
	String ver(@PathVariable(value="id") Long id,
	...
	public String guardar(@Valid Factura factura,
			  BindingResult result, //con BindigResult obtengo si hubo errores al validar la Factura
			  Model model,
		...
		if(itemId == null || itemId.length == 0) {
			model.addAttribute("error", "La Factura debe contener items");
			model.addAttribute("titulo", "Crear Factura");
			return "factura/form";
		}
